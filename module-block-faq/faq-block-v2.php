...
function _h_register_faq_block_v2() {
  ...
  wp_register_script( 'h-faq', $dir . 'v2-dist/h-faq-v2.js', [ 'wp-blocks', 'wp-dom' ] , H_VERSION, true );
  wp_register_style( 'h-faq', $dir . 'v2-dist/h-faq-v2.css', [ 'wp-edit-blocks' ], H_VERSION );
