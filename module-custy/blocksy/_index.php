...
require_once __DIR__ . '/global-scripts.php';
require_once __DIR__ . '/schema-org.php';
require_once __DIR__ . '/classes/class-ct-css-injector.php';
...
require_once __DIR__ . '/typography/core.php';
...
if ( is_admin() ) {
	require_once BLOCKSY_ROOT . '/admin/init.php';
}
